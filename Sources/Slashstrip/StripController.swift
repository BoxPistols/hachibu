...
final class StripController {
    ...
    var statusSlot: Slot? { allSlots.first { $0.id == Slot.statusID } }
    ...
    private func render() {
        ...
        let layout = LayoutRules.effective(rest: rest, expanded: hoverExpands || summoned)
        ...
        // SwiftUIの再レイアウトが済んでから大きさを測る。描き直しがもっと遅れた場合は、
        // 中身の大きさが変わった通知（onContentSizeChange）でもう一度測る
    ...
    private func fitToContent() {
        ...
        placement.fit(to: hosting.fittingSize)
    }
